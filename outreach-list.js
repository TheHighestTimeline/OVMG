...
export const handler = async (event, context) => {
  ...
  try {
    ...
    // Return the database id alongside leads so the UI can offer an
    // "Edit in Notion" link to the whole pipeline. Consumers tolerate both an
    // array (legacy) and this object shape.
    return ok({ leads, databaseId: DB.OUTREACH });
  } catch (e) {
