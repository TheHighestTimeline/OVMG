...
export const ROLES = {
  ...
  pm:             { label: 'PM',             desc: 'Project Manager — tasks, contacts, calendar, drive across assigned companies' },
...
//
// §6 requirement: EVERY company exposes Tasks, Calendar, Contacts, Drive, and
// Tools (plus a Kanban). Companies that don't have a bespoke tool set get the
...
export const COMPANY_META = {
  ovmg: {
    label:    'OVMG',
    color_hex: '#d96b3a',
    sub_tabs: ['tasks', 'calendar', 'contacts', 'kanban', 'drive', 'tools', 'playbook', 'references'],
  },
  ovm: {
    label:    'OVM',
    color_hex: '#2c5d8a',
...
export const TAB_ACCESS = {
  ...
  calendar:     ['admin', 'executive', 'operations', 'member', 'senior_partner', 'read_only'],
  booking:      ['admin', 'executive', 'operations', 'member', 'senior_partner', 'read_only'],
  playbook:     ['admin', 'executive', 'operations', 'member', 'senior_partner', 'read_only'],
...
// tab + company section (tasks, contacts, calendar, drive, tools, etc.) without
...
export const ALL_TABS = [
  ...
  'websites', 'tools', 'calendar', 'booking', 'playbook', 'references',
